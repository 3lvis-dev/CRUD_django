...
from webapp.views import home, domicilios
from personas.views import detallePersona, nuevaPersona, editarPersona, eliminarPersona, detalleDomicilio, editarDomicilio, nuevoDomicilio, eliminarDomicilio
